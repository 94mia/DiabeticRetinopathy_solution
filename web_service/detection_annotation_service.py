...
class ImageHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_OPTIONS(self):
        ...
        self.send_header("Access-Control-Allow-Headers", "X-Requested-With, Content-type, Accept, Content-Length, algo, cmd, drresult, dmeresult")
        self.end_headers()
    ...
    def _classify(self):
        ...
        self.send_header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Cookie, algo, cmd, drresult, dmeresult")
        self.send_header("idx", str(idx))
    ...
    def _doctor_confirm(self):
        ...
        self.send_header('Access-Control-Allow-Origin', '*')
        self.send_header('Access-Control-Allow-Methods', 'POST, GET')
        self.send_header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Cookie, drresult, dmeresult")
    ...
    def _get_kaggle_train_image(self):
        ...
        self.send_header('Access-Control-Allow-Origin', '*')
        self.send_header('Access-Control-Allow-Methods', 'POST, GET')
        self.send_header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Cookie, cmd, drresult, dmeresult")
        self.end_headers()
