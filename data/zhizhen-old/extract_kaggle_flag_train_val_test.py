...
def parse_args():
    ...
    parser.add_argument('--imagestxt', default='val_images.txt')
    parser.add_argument('--labelstxt', default='val_labels.txt')
...
test_df = pd.DataFrame(test_data, columns=['images', 'dr_level', 'dme_level','referable'])
#
