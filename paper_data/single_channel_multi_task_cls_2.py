...
class MultiTaskClsValDataSet(torch.utils.data.Dataset):
    ...
    def __getitem__(self, item):
        imagename = os.path.join(self.root, self.images_list[item][0] + '_' + str(self.scale_size) + '.png')
        return self.transform(Image.open(os.path.join(self.root, self.images_list[item][0]+'_'+str(self.scale_size)+'.png'))), self.images_list[item][1], self.images_list[item][2], self.images_list[item][3], imagename
...
def eval_bin(eval_data_loader, model, criterion):
    ...
    logger = []
    imagenames = []
    for index, (image, label_dr, label_dme, label_bin, imagename) in enumerate(eval_data_loader):
    ...
    log_dr_bin_cls = '[DR binary cls]: acc: {acc:.4f}\tsensitivity: {s1:.4f}\tspecificity: {s2:.4f}'.format(
        acc = dr_bin_accuray,
        s1 = dr_s1,
        s2 = dr_s2
    )
    ...
    log_dme_bin_cls = '[DME binary cls]: acc: {acc:.4f}\tsensitivity: {s1:.4f}\tspecificity: {s2:.4f}'.format(
        acc=dme_bin_accuray,
        s1=dme_s1,
        s2=dme_s2
    )
    ...
    log_mix_bin_cls = '[MIX binary cls]: acc: {acc:.4f}\tsensitivity: {s1:.4f}\tspecificity: {s2:.4f}'.format(
        acc=mix_bin_accuray,
        s1=mix_s1,
        s2=mix_s2
    )
    ...
    #
    #
    # assert len(tot_pred_dr) == len(imagenames)
    #
    # for i in range(len(tot_pred_dme)):
    #     if tot_label_dme[i] == 0:
    #         dme_level = tot_pred_dme[i]
    #         if dme_level == 0:
    #             gt_0_dme_0.append(imagenames[i])
    #         elif dme_level == 1:
    #             gt_0_dme_1.append(imagenames[i])
    #         elif dme_level == 2:
    #             gt_0_dme_2.append(imagenames[i])
    #         elif dme_level == 3:
    #             gt_0_dme_3.append(imagenames[i])
    #     elif tot_label_dme[i] == 1:
    #         dme_level = tot_pred_dme[i]
    #         if dme_level == 0:
    #             gt_1_dme_0.append(imagenames[i])
    #         elif dme_level == 1:
    #             gt_1_dme_1.append(imagenames[i])
    #         elif dme_level == 2:
    #             gt_1_dme_2.append(imagenames[i])
    #         elif dme_level == 3:
    #             gt_1_dme_3.append(imagenames[i])
    #     elif tot_label_dme[i] == 2:
    #         dme_level = tot_pred_dme[i]
    #         if dme_level == 0:
    #             gt_2_dme_0.append(imagenames[i])
    #         elif dme_level == 1:
    #             gt_2_dme_1.append(imagenames[i])
    #         elif dme_level == 2:
    #             gt_2_dme_2.append(imagenames[i])
    #         elif dme_level == 3:
    #             gt_2_dme_3.append(imagenames[i])
    #     elif tot_label_dme[i] == 3:
    #         dme_level = tot_pred_dme[i]
    #         if dme_level == 0:
    #             gt_3_dme_0.append(imagenames[i])
    #         elif dme_level == 1:
    #             gt_3_dme_1.append(imagenames[i])
    #         elif dme_level == 2:
    #             gt_3_dme_2.append(imagenames[i])
    #         elif dme_level == 3:
    #             gt_3_dme_3.append(imagenames[i])
    #
    # gt_pred = []
    #
    # gt_pred.append(gt_0_dme_0)
    # gt_pred.append(gt_0_dme_1)
    # gt_pred.append(gt_0_dme_2)
    # gt_pred.append(gt_0_dme_3)
    #
    # gt_pred.append(gt_1_dme_0)
    # gt_pred.append(gt_1_dme_1)
    # gt_pred.append(gt_1_dme_2)
    # gt_pred.append(gt_1_dme_3)
    #
    # gt_pred.append(gt_2_dme_0)
    # gt_pred.append(gt_2_dme_1)
    # gt_pred.append(gt_2_dme_2)
    # gt_pred.append(gt_2_dme_3)
    #
    # gt_pred.append(gt_3_dme_0)
    # gt_pred.append(gt_3_dme_1)
    # gt_pred.append(gt_3_dme_2)
    # gt_pred.append(gt_3_dme_3)
    #
    # err_folder = './dme_err_images'
    # for i in range(4):
    #     for j in range(4):
    #         dir = os.path.join(err_folder, 'gt_{0}_pred_{1}'.format(i, j))
    #         os.makedirs(dir, exist_ok=True)
    #
    # import shutil
    # for i, l in enumerate(gt_pred):
    #     if i == 0 or i == 5 or i == 10 or i == 15:
    #         continue
    #     for ll in l:
    #         shutil.copy(ll, os.path.join(err_folder, 'gt_{0}_pred_{1}'.format(i//4, i%4)))
    #
    # err_all = os.path.join(err_folder, 'err_all')
    # os.makedirs(err_all, exist_ok=True)
    #
    # for i in range(len(tot_pred_dme)):
    #     if tot_pred_dr[i] != tot_label_dr[i] or tot_pred_dme[i] != tot_label_dme[i]:
    #         base_str = os.path.basename(imagenames[i]).replace('_512.png','')
    #         shutil.copy(imagenames[i], os.path.join(err_all, '{0}_dr_gt_{1}_pred{2}_dme_gt_{3}_dme_{4}.png'.format(
    #             base_str, tot_label_dr[i], tot_pred_dr[i], tot_label_dme[i], tot_pred_dme[i]
    #         )))
