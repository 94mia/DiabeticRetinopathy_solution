...
CUDA_VISIBLE_DEVICES=0,1,2,3 python multi_channel_multi_task_classification.py --root ../data/kaggle/512 --root_augumentation ../data/kaggle/512_ahe --traincsv ../data/kaggle/train_multi.csv --valcsv ../data/kaggle/val_multi.csv --testcsv ../data/kaggle/test_bin.csv --model rsn34 --batch 32 --workers 8 --epoch 100 --display 50
