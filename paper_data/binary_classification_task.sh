...
#CUDA_VISIBLE_DEVICES=0,1,2,3 python binary_classification_3_task.py --root ../data/zhizhen_new/LabelImages/512 --traincsv ../data/zhizhen_new/LabelImages/train_multi.csv --valcsv ../data/zhizhen_new/LabelImages/val_multi.csv --testcsv ../data/zhizhen_new/LabelImages/test_multi.csv --workers 8 --batch 64 --epoch 100 --display 100

CUDA_VISIBLE_DEVICES=0,1,2,3 python binary_classification_3_task.py --root ../data/zhizhen_new/LabelImages/512 --traincsv ../data/zhizhen_new/LabelImages/train_multi.csv --valcsv ../data/zhizhen_new/LabelImages/val_multi.csv --testcsv ../data/zhizhen_new/LabelImages/test_multi.csv --workers 8 --batch 64 --epoch 100 --display 100 --weight /home/weidong/code/github/DiabeticRetinopathy_solution/paper_data/output/kaggle_binary_cls_train_20171011112012_googlenet_binary_cls/kaggle_binarycls_googlenet_013_dme_sensitivity_best.pth --phase test
