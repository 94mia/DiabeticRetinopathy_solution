...
#CUDA_VISIBLE_DEVICES=0,1,2,3 python single_channel_multi_task_cls_concatenate.py --root ../data/zhizhen_new/LabelImages/512 --traincsv ../data/zhizhen_new/LabelImages/train_multi.csv --valcsv ../data/zhizhen_new/LabelImages/val_multi.csv --testcsv ../data/zhizhen_new/LabelImages/test_multi.csv --model rsn34 --batch 64 --workers 4 --epoch 150 --display 50 --crop 448 --size 512 --exp concatenation_bin_cls --weight /home/weidong/code/github/DiabeticRetinopathy_solution/paper_data/output/kaggle_multi_task_cls_train_20170914195436_rsn34_concatenation_bin_cls/kaggle_multi_task_cls_dr_rsn34_025_best.pth --phase infer --infer_root ../data/zhizhen_new/inference


### train

CUDA_VISIBLE_DEVICES=0,1,2,3 python single_channel_multi_task_cls_concatenate.py --root ../data/zhizhen_new/LabelImages/512 --traincsv ../data/zhizhen_new/LabelImages/train_multi.csv --valcsv ../data/zhizhen_new/LabelImages/val_multi.csv --testcsv ../data/zhizhen_new/LabelImages/test_multi.csv --model rsn34 --batch 64 --workers 4 --epoch 50 --display 50 --crop 448 --size 512 --exp concatenation_bin_cls_dme_aug --dme_weight_aug 8.0
CUDA_VISIBLE_DEVICES=0,1,2,3 python single_channel_multi_task_cls_concatenate.py --root ../data/zhizhen_new/LabelImages/512 --traincsv ../data/zhizhen_new/LabelImages/train_multi.csv --valcsv ../data/zhizhen_new/LabelImages/val_multi.csv --testcsv ../data/zhizhen_new/LabelImages/test_multi.csv --model rsn34 --batch 64 --workers 4 --epoch 50 --display 50 --crop 448 --size 512 --exp concatenation_bin_cls_dme_aug --dme_weight_aug 2.0
CUDA_VISIBLE_DEVICES=0,1,2,3 python single_channel_multi_task_cls_concatenate.py --root ../data/zhizhen_new/LabelImages/512 --traincsv ../data/zhizhen_new/LabelImages/train_multi.csv --valcsv ../data/zhizhen_new/LabelImages/val_multi.csv --testcsv ../data/zhizhen_new/LabelImages/test_multi.csv --model rsn34 --batch 64 --workers 4 --epoch 50 --display 50 --crop 448 --size 512 --exp concatenation_bin_cls_dme_aug --dme_weight_aug 3.0